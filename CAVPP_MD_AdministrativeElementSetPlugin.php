<?php
/**
 * CAVPP PBCore Administrative Descriptive Metadata Element Set plugin
 *
 * Creates a custom admin descriptive element set for 
...
/**
 * The CAVPP PBCore Administrative Descriptive Metadata Element Set plugin.
